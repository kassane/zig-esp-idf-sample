...
if(DEFINED ENV{IDF_TOOLS_PATH})
    if(CMAKE_HOST_SYSTEM_NAME STREQUAL "Windows")
        ...
        set(TOOLCHAIN_BASE_PATH "${IDF_TOOLS_PATH_NORMALIZED}/tools/${TRIPLE}")
    else()
        set(TOOLCHAIN_BASE_PATH "$ENV{IDF_TOOLS_PATH}/tools/${TRIPLE}")
    endif()
else()
    set(TOOLCHAIN_BASE_PATH "$ENV{HOME}/.espressif/tools/${TRIPLE}")
endif()
