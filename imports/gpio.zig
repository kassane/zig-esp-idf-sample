...
pub const Num = enum(sys.gpio_num_t) {
    ...
    GPIO_NUM_0 = if (@hasDecl(sys, "GPIO_NUM_0")) sys.GPIO_NUM_0 else 0,
    GPIO_NUM_1 = if (@hasDecl(sys, "GPIO_NUM_1")) sys.GPIO_NUM_1 else 1,
    GPIO_NUM_2 = if (@hasDecl(sys, "GPIO_NUM_2")) sys.GPIO_NUM_2 else 2,
    GPIO_NUM_3 = if (@hasDecl(sys, "GPIO_NUM_3")) sys.GPIO_NUM_3 else 3,
    GPIO_NUM_4 = if (@hasDecl(sys, "GPIO_NUM_4")) sys.GPIO_NUM_4 else 4,
    GPIO_NUM_5 = if (@hasDecl(sys, "GPIO_NUM_5")) sys.GPIO_NUM_5 else 5,
    GPIO_NUM_6 = if (@hasDecl(sys, "GPIO_NUM_6")) sys.GPIO_NUM_6 else 6,
    GPIO_NUM_7 = if (@hasDecl(sys, "GPIO_NUM_7")) sys.GPIO_NUM_7 else 7,
    GPIO_NUM_8 = if (@hasDecl(sys, "GPIO_NUM_8")) sys.GPIO_NUM_8 else 8,
    GPIO_NUM_9 = if (@hasDecl(sys, "GPIO_NUM_9")) sys.GPIO_NUM_9 else 9,
    GPIO_NUM_10 = if (@hasDecl(sys, "GPIO_NUM_10")) sys.GPIO_NUM_10 else 10,
    GPIO_NUM_11 = if (@hasDecl(sys, "GPIO_NUM_11")) sys.GPIO_NUM_11 else 11,
    GPIO_NUM_12 = if (@hasDecl(sys, "GPIO_NUM_12")) sys.GPIO_NUM_12 else 12,
    GPIO_NUM_13 = if (@hasDecl(sys, "GPIO_NUM_13")) sys.GPIO_NUM_13 else 13,
    GPIO_NUM_14 = if (@hasDecl(sys, "GPIO_NUM_14")) sys.GPIO_NUM_14 else 14,
    GPIO_NUM_15 = if (@hasDecl(sys, "GPIO_NUM_15")) sys.GPIO_NUM_15 else 15,
    GPIO_NUM_16 = if (@hasDecl(sys, "GPIO_NUM_16")) sys.GPIO_NUM_16 else 16,
    GPIO_NUM_17 = if (@hasDecl(sys, "GPIO_NUM_17")) sys.GPIO_NUM_17 else 17,
    GPIO_NUM_18 = if (@hasDecl(sys, "GPIO_NUM_18")) sys.GPIO_NUM_18 else 18,
    GPIO_NUM_19 = if (@hasDecl(sys, "GPIO_NUM_19")) sys.GPIO_NUM_19 else 19,
    GPIO_NUM_20 = if (@hasDecl(sys, "GPIO_NUM_20")) sys.GPIO_NUM_20 else 20,
    GPIO_NUM_21 = if (@hasDecl(sys, "GPIO_NUM_21")) sys.GPIO_NUM_21 else 21,
    GPIO_NUM_22 = if (@hasDecl(sys, "GPIO_NUM_22")) sys.GPIO_NUM_22 else 22,
    GPIO_NUM_23 = if (@hasDecl(sys, "GPIO_NUM_23")) sys.GPIO_NUM_23 else 23,
    GPIO_NUM_24 = if (@hasDecl(sys, "GPIO_NUM_24")) sys.GPIO_NUM_24 else 24,
    GPIO_NUM_25 = if (@hasDecl(sys, "GPIO_NUM_25")) sys.GPIO_NUM_25 else 25,
    GPIO_NUM_26 = if (@hasDecl(sys, "GPIO_NUM_26")) sys.GPIO_NUM_26 else 26,
    GPIO_NUM_27 = if (@hasDecl(sys, "GPIO_NUM_27")) sys.GPIO_NUM_27 else 27,
    GPIO_NUM_28 = if (@hasDecl(sys, "GPIO_NUM_28")) sys.GPIO_NUM_28 else 28,
    GPIO_NUM_29 = if (@hasDecl(sys, "GPIO_NUM_29")) sys.GPIO_NUM_29 else 29,
    GPIO_NUM_30 = if (@hasDecl(sys, "GPIO_NUM_30")) sys.GPIO_NUM_30 else 30,
    GPIO_NUM_31 = if (@hasDecl(sys, "GPIO_NUM_31")) sys.GPIO_NUM_31 else 31,
    GPIO_NUM_32 = if (@hasDecl(sys, "GPIO_NUM_32")) sys.GPIO_NUM_32 else 32,
    GPIO_NUM_33 = if (@hasDecl(sys, "GPIO_NUM_33")) sys.GPIO_NUM_33 else 33,
    GPIO_NUM_34 = if (@hasDecl(sys, "GPIO_NUM_34")) sys.GPIO_NUM_34 else 34,
    GPIO_NUM_35 = if (@hasDecl(sys, "GPIO_NUM_35")) sys.GPIO_NUM_35 else 35,
    GPIO_NUM_36 = if (@hasDecl(sys, "GPIO_NUM_36")) sys.GPIO_NUM_36 else 36,
    GPIO_NUM_37 = if (@hasDecl(sys, "GPIO_NUM_37")) sys.GPIO_NUM_37 else 37,
    GPIO_NUM_38 = if (@hasDecl(sys, "GPIO_NUM_38")) sys.GPIO_NUM_38 else 38,
    GPIO_NUM_39 = if (@hasDecl(sys, "GPIO_NUM_39")) sys.GPIO_NUM_39 else 39,
    GPIO_NUM_40 = if (@hasDecl(sys, "GPIO_NUM_40")) sys.GPIO_NUM_40 else 40,
    GPIO_NUM_41 = if (@hasDecl(sys, "GPIO_NUM_41")) sys.GPIO_NUM_41 else 41,
    GPIO_NUM_42 = if (@hasDecl(sys, "GPIO_NUM_42")) sys.GPIO_NUM_42 else 42,
    GPIO_NUM_43 = if (@hasDecl(sys, "GPIO_NUM_43")) sys.GPIO_NUM_43 else 43,
    GPIO_NUM_44 = if (@hasDecl(sys, "GPIO_NUM_44")) sys.GPIO_NUM_44 else 44,
    GPIO_NUM_45 = if (@hasDecl(sys, "GPIO_NUM_45")) sys.GPIO_NUM_45 else 45,
    GPIO_NUM_46 = if (@hasDecl(sys, "GPIO_NUM_46")) sys.GPIO_NUM_46 else 46,
    GPIO_NUM_47 = if (@hasDecl(sys, "GPIO_NUM_47")) sys.GPIO_NUM_47 else 47,
    GPIO_NUM_48 = if (@hasDecl(sys, "GPIO_NUM_48")) sys.GPIO_NUM_48 else 48,
